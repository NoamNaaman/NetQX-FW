...
// load date/time from RTC chip. if it is corrupted, reload from eeprom and save in RTC
...
//  sys_date_time.month = sDate.Month;
//  sys_date_time.day = sDate.Date;
//  sys_date_time.year = sDate.Year;
//  delay_us(50);
//  HAL_RTC_GetTime(&hrtc, &sTime, RTC_FORMAT_BIN);
//  sys_date_time.hour   = sTime.Hours;
//  sys_date_time.minute = sTime.Minutes;
//  sys_date_time.second = sTime.Seconds;
////  day_of_week = dtw[3];
//  }
