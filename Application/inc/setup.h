...
#define SW_VERSION 146
// 145 2021-11-01 added 4 hour reset interval to elevator system
// 144 2021-06-02 improved checking of RDR4 reader comm
// 143 2021-06-02 checking no response from all RDR4 readers
// 142 2021-05-31 fixed RDR4 #1 RX interrupt enabling
// 141 2021-05-21 fixed RDR4 timer interrupt handling
// 140 2021-05-20 fixed IOX addressing
// 139 2021-05-19 fixed EVT_valid_entry in elevator mode.
// 138 2021-05-09 elevator system working
// 137 2021-02-14 fixed access level door mask computation
...
#define ADDR_DOORS        (((u32)ADDR_KEYS + MAX_KEY_RECORDS * sizeof(KEY_RECORD) + 256) & 0xFFFFFF00L)
#define ADDR_TZ           ((ADDR_DOORS + 2 * sizeof(DOOR_RECORD) + 256) & 0xFFFFFF00L)
...
#define DEBUG_OUT          GPIOB,11

#define IOX_RST             GPIOF,5

#define ETH_RST             GPIOD,3
#define XPORT_EN            ETH_RST
...
// I/O expander ports bit masks on port P2x
// outputs
...
#define RDR_BUZZER4   GPIOF,6

#define RELAY9        GPIOD,10
#define RELAY10       GPIOD,9
#define LED_GREEN     GPIOF,1
...
void process_key(u8 source, u32 key, u16 special);
...
extern const u32 Tmr_1sec_Elev_Reset    ; //  4
